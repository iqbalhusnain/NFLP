...
class participants_area_third : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_participants_area_third)
        ...
        age1.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(
                ...
                selectedage1 = parent?.getItemAtPosition(position).toString()
            }
        }
        ...
        bankname2.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(
                ...
                tempselectedbank2 = if (accountopened2.isChecked) {
        ...
        age3.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(
                ...
                selectedage3 = parent?.getItemAtPosition(position).toString()
            }
        }
        ...
        bankname4.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(
                ...
                tempselectedbank4 = if (accountopened4.isChecked) {
                    parent?.getItemAtPosition(position).toString()
                } else {
                    "N/A"
                }
        ...
        bankname5.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(
                ...
                tempselectedbank5 = if (accountopened5.isChecked) {
                    parent?.getItemAtPosition(position).toString()
                } else {
                    "N/A"
                }
        ...
        bankname6.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(
                ...
                tempselectedbank6 = if (accountopened6.isChecked) {
                    parent?.getItemAtPosition(position).toString()
                } else {
                    "N/A"
                }
        ...
        bankname7.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(
                ...
                tempselectedbank7 = if (accountopened7.isChecked) {
                    parent?.getItemAtPosition(position).toString()
                } else {
                    "N/A"
                }
        ...
        bankname8.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(
                ...
                tempselectedbank8 = if (accountopened8.isChecked) {
                    parent?.getItemAtPosition(position).toString()
                } else {
                    "N/A"
                }
        ...
        bankname9.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(
                ...
                tempselectedbank9 = if (accountopened9.isChecked) {
                    parent?.getItemAtPosition(position).toString()
                } else {
                    "N/A"
                }
        ...
        bankname10.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(
                ...
                tempselectedbank10 = if (accountopened10.isChecked) {
                    parent?.getItemAtPosition(position).toString()
                } else {
                    "N/A"
                }
...
//            }else
            if (participantsNumbers == "31") {
                if (size1 != 13) {
                    ...
                    val row1: Row = sheet2.createRow(31)
                    val row1cell1: Cell = row1.createCell(0)
                    row1cell1.setCellValue("31")
                    ...
                    fileOut.close()
                    workbook.close()
                    val intent = Intent(this@participants_area_third, thankyou::class.java)
                    intent.putExtra("filename", filename)
                    intent.putExtra("participantsNumbers",participantsNumbers)
                    startActivity(intent)
                }
            }else if (participantsNumbers == "32") {
                if (size1 != 13) {
                    cnic1.error = "Invalid CNIC"
                    cnic1.requestFocus()
                    Toast.makeText(this, "Invalid CNIC of Participant 1", Toast.LENGTH_LONG).show()
                    ...
                    val row3: Row = sheet2.createRow(32)
                    val row3cell1: Cell = row3.createCell(0)
                    row3cell1.setCellValue("32")
            ...
            } else if (participantsNumbers == "33") {
                if (size1 != 13) {
                    cnic1.error = "Invalid CNIC"
                    cnic1.requestFocus()
                    Toast.makeText(this, "Invalid CNIC of Participant 1", Toast.LENGTH_LONG).show()
                    ...
                    val row4: Row = sheet2.createRow(33)
                    val row4cell1: Cell = row4.createCell(0)
                    row4cell1.setCellValue("33")
            ...
            } else if (participantsNumbers == "34") {
                if (size1 != 13) {
                    cnic1.error = "Invalid CNIC"
                    cnic1.requestFocus()
                    Toast.makeText(this, "Invalid CNIC of Participant 1", Toast.LENGTH_LONG).show()
                    ...
                    val row5: Row = sheet2.createRow(34)
                    val row5cell1: Cell = row5.createCell(0)
                    row5cell1.setCellValue("34")
            ...
            } else if (participantsNumbers == "35") {
                if (size1 != 13) {
                    cnic1.error = "Invalid CNIC"
                    cnic1.requestFocus()
                    Toast.makeText(this, "Invalid CNIC of Participant 1", Toast.LENGTH_LONG).show()
                    ...
                    val row6: Row = sheet2.createRow(35)
                    val row6cell1: Cell = row6.createCell(0)
                    row6cell1.setCellValue("35")
            ...
            } else if (participantsNumbers == "36") {
                if (size1 != 13) {
                    cnic1.error = "Invalid CNIC"
                    cnic1.requestFocus()
                    Toast.makeText(this, "Invalid CNIC of Participant 1", Toast.LENGTH_LONG).show()
                    ...
                    val row7: Row = sheet2.createRow(36)
                    val row7cell1: Cell = row7.createCell(0)
                    row7cell1.setCellValue("36")
            ...
            }else if (participantsNumbers == "37") {
                if (size1 != 13) {
                    cnic1.error = "Invalid CNIC"
                    cnic1.requestFocus()
                    Toast.makeText(this, "Invalid CNIC of Participant 1", Toast.LENGTH_LONG).show()
                    ...
                    val row8: Row = sheet2.createRow(37)
                    val row8cell1: Cell = row8.createCell(0)
                    row8cell1.setCellValue("37")
            ...
            }else if (participantsNumbers == "38") {
                if (size1 != 13) {
                    cnic1.error = "Invalid CNIC"
                    cnic1.requestFocus()
                    Toast.makeText(this, "Invalid CNIC of Participant 1", Toast.LENGTH_LONG).show()
                    ...
                    val row9: Row = sheet2.createRow(38)
                    val row9cell1: Cell = row9.createCell(0)
                    row9cell1.setCellValue("38")
            ...
            }else if (participantsNumbers == "39") {
                if (size1 != 13) {
                    cnic1.error = "Invalid CNIC"
                    cnic1.requestFocus()
                    Toast.makeText(this, "Invalid CNIC of Participant 1", Toast.LENGTH_LONG).show()
                    ...
                    val row10: Row = sheet2.createRow(39)
                    val row10cell1: Cell = row10.createCell(0)
                    row10cell1.setCellValue("39")
            ...
            }else if (participantsNumbers == "40") {
                if (size1 != 13) {
                    cnic1.error = "Invalid CNIC"
                    cnic1.requestFocus()
                    Toast.makeText(this, "Invalid CNIC of Participant 1", Toast.LENGTH_LONG).show()
                    ...
                    val row11: Row = sheet2.createRow(40)
                    val row11cell1: Cell = row11.createCell(0)
                    row11cell1.setCellValue("40")
